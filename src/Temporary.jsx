...
//     setIsLoading(true);
//     setError(null);
//     setSuccessMessage(null); // Reset success message before the operation
...
//       const { msg } = response.data; // Extracting the message from the API response
//       setSuccessMessage(msg || "Prompt saved successfully!"); // Update success message
